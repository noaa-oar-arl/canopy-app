...
[**Modules**](modules.md) **>** [**tleaf\_group**](group__tleaf__group.md)



_Routines for calculating leaf temperatures in forest canopies._ [More...](#detailed-description)
...
This group contains subroutines for calculating leaf temperatures for sunlit and shaded leaves using linear interpolation methods based on Silva et al. (2020) parameterizations. 
