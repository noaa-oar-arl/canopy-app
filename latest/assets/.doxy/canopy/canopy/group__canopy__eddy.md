...
[**Modules**](modules.md) **>** [**canopy\_eddy**](group__canopy__eddy.md)



_Eddy diffusivity calculations within and above canopy._ 
...
| Type | Name |
| ---: | :--- |
|  subroutine | [**canopy\_eddy\_mod::canopy\_eddyx**](#function-canopy_eddyx) (HCM HCM, ZK ZK, USTAR USTAR, MOL MOL, KZ KZ) <br>_Calculate canopy eddy diffusivity._  |
