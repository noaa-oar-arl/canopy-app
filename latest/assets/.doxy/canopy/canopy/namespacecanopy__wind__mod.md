...
# Namespace canopy\_wind\_mod



[**Namespace List**](namespaces.md) **>** [**canopy\_wind\_mod**](namespacecanopy__wind__mod.md)
...
| Type | Name |
| ---: | :--- |
|  subroutine | [**canopy\_wind\_most**](#function-canopy_wind_most) (HCM HCM, ZK ZK, FAFRACK FAFRACK, UBZREF UBZREF, Z0GHC Z0GHC, CDRAG CDRAG, PAI PAI, HREF HREF, D\_H D\_H, ZO\_H ZO\_H, LAMBDARS LAMBDARS, CANBOT\_OUT CANBOT\_OUT, CANTOP\_OUT CANTOP\_OUT, CANWIND CANWIND) <br>_Calculate canopy wind speed profile using MOST._  |
...
------------------------------
The documentation for this class was generated from the following file `src/canopy_wind_mod.F90`
