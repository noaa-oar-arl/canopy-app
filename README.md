...
| `fh`                             | Forest canopy height (m)                    | Fused GEDI/Landsat data. Data Period=2020. Data frequency=Static. ([Potapov et al., 2020](https://doi.org/10.1016/j.rse.2020.112165)) |
...
| `pavd`                           | Plant area volume density (m2/m3)           | [GEDI product from North Arizona University](https://goetzlab.rc.nau.edu/index.php/gedi/). Data Period=201904-202212 Climatology. Data frequency=Static. |
